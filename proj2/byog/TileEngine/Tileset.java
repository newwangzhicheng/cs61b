...
public class Tileset {
        ...
        public static final TETile CUSTOM_FLOOR = new TETile('·', new Color(128, 192, 128), Color.black, "custom floor",
                        "https://icons.iconarchive.com/icons/papirus-team/papirus-apps/16/emerald-theme-manager-icon-icon.png");
        public static final TETile CUSTOM_WALL = new TETile('#', new Color(216, 128, 128), Color.darkGray,
                        "custom wall",
